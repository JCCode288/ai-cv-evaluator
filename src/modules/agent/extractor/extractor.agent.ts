...
export class ExtractorAgent implements AgentStrategy {
    ...
    private readonly graph: CompiledStateGraph<any, any, any, any, any, any, any, any, any>;
    ...
    private async extractCv(state: z.infer<typeof ExtractorState>): Promise<Partial<z.infer<typeof ExtractorState>>> {
    ...
    private async buildExtractorChain() {
        ...
        const promptWithInstructions = await this.prompts.EXTRACT.partial({ format_instructions: parser.getFormatInstructions() });
